...
interface OSOperation {
  ...
  getChromeProfilePath(): Promise<string | null> | string | null;
  checkOS(browser: "chrome" | "firefox"): Promise<boolean> | boolean;
}
...
const linuxOperation: OSOperation = {
  ...
  getChromeProfilePath() {
    throw new Error("Linux getChromeProfilePath not implemented yet");
  },
  checkOS() {
    return true;
  },
...
export async function getOSOperations(): Promise<OSOperation> {
  let op;
